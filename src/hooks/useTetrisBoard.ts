...
export const getEmptyBoard = (height = BOARD_HEIGHT): BoardShape => {
  return Array(height)
    .fill(null)
    .map(() => Array(BOARD_WIDTH).fill(EmptyCell.Empty))
}

export const rotateBlock = (shape: BlockShape): BlockShape => {
...
export const hasCollisions = (board: BoardShape, currentShape: BlockShape, row: number, column: number): boolean => {
